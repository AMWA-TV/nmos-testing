...
Provide the IP or hostname and port of the relevant API under test, along with the preferred API version. | ![Testing Tool Launcher](../assets/images/test-setup.png "Testing Tool Launcher")
Optionally, select a subset of the tests to run. This should default to 'all'. | ![Testing Tool Launcher](../assets/images/test-selection.png "Testing Tool Launcher")
