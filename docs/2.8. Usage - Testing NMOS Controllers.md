...
## Test Suite Overview
The NC-01 NMOS Controller test suite maps the tests described in Sections 7 and 8 of the [JT-NM Tested March 2020 AMWA NMOS / JT-NM TR-1001-1 Media Nodes, Registries, Controllers Results Catalog](https://static.jt-nm.org/documents/JT-NM_Tested_Catalog_NMOS-TR-1001_Full-Online-2020-05-12.pdf).
...
* *On Testing Façade:* Click the ‘Next’ button.
* *On NCuT:* If necessary, refresh the view.
* *On Testing Façade:* Select the Sender which has been put ‘offline’.
* *On Testing Façade:* Click the ‘Next’ button only once the Sender comes back ‘online’.
...
* *On Testing Façade:* Click the 'Next' button once the connection is active.
...
#### Description
The NCuT shall be able to remove an active connection through via IS-05 API. 
...
* *On Testing Façade:* Click the 'Next' button once the connection has been deactivated.
...
* A Receiver connection is deactivated in the background by the Testing Tool within the proceeding 60 seconds. 
