...
The list of possible answers are specified according to [QuestionSchema.json](../testingfacade/Docs/QuestionSchema.json).
...
The format of the answer returned by `_invoke_testing_facade` is specified according to [AnswerSchema.json](../testingfacade/Docs/AnswerSchema.json).

Examples of the JSON posted to the TestingFaçade, and the TestingFaçade's JSON responses posted back to the Testing tool can be found in [examples](../testingfacade/Docs/).
