...
Examples of the JSON posted to the TestingFaçade, and the TestingFaçade's responses posted back to the Testing tool can be found in [examples](../testingfacade/examples).
