...
`ControllerTest` provides helper functions for setting up mock resources, and sending and receiving quesions/answers to a Testing Fa�ade.
...
**Sending Questions to the Testing Fa�ade**

Questions are sent to the Testing Fa�ade using the `_invoke_testing_facade` helper function.
The question to be displayed to the User on the Testing Fa�ade is specified as plain text.
...
Examples of the JSON posted to the TestingFa�ade, and the TestingFa�ade's JSON responses posted back to the Testing tool can be found in [examples](../testingfacade/examples/).
